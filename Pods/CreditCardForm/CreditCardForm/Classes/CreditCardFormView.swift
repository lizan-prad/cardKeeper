...
public class CreditCardFormView : UIView {
    ...
    private func createChipImage() {
        ...
        chipImg.alpha = 0.5
        chipImg.image = chipImage
        chipImg.contentMode = .scaleToFill
        ...
        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:[view(==60)]", options: NSLayoutConstraint.FormatOptions(rawValue: 0), metrics: nil, views: ["view": chipImg]));
